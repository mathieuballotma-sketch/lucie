...
Salvagé depuis archive/pre-cleanup:app/brain/cortex/quantum_models.py.
Aucune dépendance externe — dataclasses et enums purs.
"""
...
class CollapseResult:
    ...
    fusion_detail: str = ""       # Détail lisible de la décision de fusion
