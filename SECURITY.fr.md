...
considérées est dans [`docs/THREAT_MODEL.fr.md`](docs/THREAT_MODEL.fr.md).
...
| Catégorie | Action |
|-----------|--------|
| Vulnérabilité critique (exfiltration de données) | divulgation après fix, crédit dans `CHANGELOG.fr.md` |
...
| Vulnérabilité faible (info disclosure non sensible) | fix au prochain sprint, mention dans `CHANGELOG.fr.md` |
...
- [`PRINCIPLES.fr.md`](PRINCIPLES.fr.md) — principe 1 (100 % local) et
