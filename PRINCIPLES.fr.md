...
[`docs/EVIDENCE.fr.md`](docs/EVIDENCE.fr.md) et
...
Ce qui est cassé est documenté ([`KNOWN_ISSUES.fr.md`](KNOWN_ISSUES.fr.md)).
Ce qui a changé est daté ([`CHANGELOG.fr.md`](CHANGELOG.fr.md)). Ce qui a
...
modules en stash. Voir [`docs/THREAT_MODEL.fr.md`](docs/THREAT_MODEL.fr.md).
...
| Transparence radicale | [`KNOWN_ISSUES.fr.md`](KNOWN_ISSUES.fr.md), [`CHANGELOG.fr.md`](CHANGELOG.fr.md), [`docs/sprints/SUMMARY.fr.md`](docs/sprints/SUMMARY.fr.md), [`docs/EVIDENCE.fr.md`](docs/EVIDENCE.fr.md), [`docs/REPRODUCE.fr.md`](docs/REPRODUCE.fr.md) |
